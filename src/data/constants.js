export const Bio = {
  name: "Ruihao (Ray) Zhang",
  roles: ["Software Engineer", "Machine Learning Engineer"],
  description:
    "I am a master of Computer Science at Rice University with background in software engineering, machine learning and deep learning. My studies and experiences center on full stack development, large language models (LLMs) and applications of LLMs.",
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Pandas",
        image:
          "https://raw.githubusercontent.com/gilbarbara/logos/92bb74e98bca1ea1ad794442676ebc4e75038adc/logos/pandas-icon.svg",
      },
      {
        name: "Streamlit",
      ...
      {
        name: "Deepspeed",
        image: "https://avatars.githubusercontent.com/u/74068820?s=200&v=4",
      },
      {
        name: "LangChain",
        image:
          "https://raw.githubusercontent.com/simple-icons/simple-icons/b5b10c5648db79d651948012fabf012bc639a5f1/icons/langchain.svg",
      },
    ],
  },
  {
...
export const projects = [
  {
    id: 0,
    title: "Watermarking for Voice Cloning Models",
    date: "Dec 2023",
    description:
      "To mitigate societal risks such as voice scams enabled by generative AI, we embed a watermark into audio, enabling the detection of generated outputs from voice cloning models like VALL-E-X.",
    image:
      "https://github.com/ObsisMc/VoiceCloningWatermark/blob/main/.assets/voicecloning/architecture.png?raw=true",
    tags: [
      "Python",
      "Pytorch",
      "HuggingFace",
    ...
    github: "https://github.com/ObsisMc/VoiceCloningWatermark",
    webapp: "",
  },
  {
    id: 1,
    ...
    date: "Jan 2022",
    description:
      "An Automatic Annotation tool for 3D point clouds, including 3D object detection and tracking.",
    image:
      "https://github.com/naurril/SUSTechPOINTS/blob/dev-auto-annotate/doc/main-ui.png?raw=true",
    tags: [
      "Pytorch",
      "3D Object Detection",
      "3D Object Tracking",
    ...
    category: "Machine Learning",
    github:
      "https://github.com/ObsisMc/Automatic-Annotation-of-3D-Point-Cloud?tab=readme-ov-file",
    webapp: "",
  },
  {
    id: 2,
    title: "Tic-tac-toe",
    date: "Jan 2025",
    description: "A simple tic-tac-toe game developed by React",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Tic_tac_toe.svg/1024px-Tic_tac_toe.svg.png",
    tags: ["React"],
    category: "Web App",
    github: "https://github.com/ObsisMc/tic-tac-toe",
    webapp: "https://obsismc.github.io/tic-tac-toe/",
  },
  {
    id: 3,
    title: "Quiz App",
